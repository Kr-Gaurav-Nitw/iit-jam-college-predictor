...
# Page config
# ---------------------------
st.set_page_config(page_title="JAM College Predictor", page_icon="🎓", layout="centered")
...
st.markdown("Predict your IIT chances ")
    ...
    if candidate_insts.empty:
        ...
        if rank > max_cutoff:
            ...
            if not rows:
                ...
                # 🔹 Sort by Open_Mean (smaller = higher preference), then by diff
